...
public class Property { 
    ...
    public Property(Integer propertyId, String name, String description, Integer location, String createdBy, Date created, String updatedBy, Date updated, Set<Task> tasks)
    {
